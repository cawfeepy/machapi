...
from ...models.patched_leg import PatchedLeg
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedLeg | PatchedLeg | PatchedLeg | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedLeg | Unset): Declarative mixin that handles nested writes automatically
