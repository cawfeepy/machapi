...
from ...models.patched_shipment_assignment import PatchedShipmentAssignment
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedShipmentAssignment
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/shipment-assignments/{id}/".format(
            id=quote(str(id), safe=""),
        ),
    }

    if isinstance(body, PatchedShipmentAssignment):
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ShipmentAssignment.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedShipmentAssignment | Unset): Serializer for the ShipmentAssignment model.
