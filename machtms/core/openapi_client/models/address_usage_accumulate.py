...
T = TypeVar("T", bound="AddressUsageAccumulate")


@_attrs_define
class AddressUsageAccumulate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        address_usage_accumulate.additional_properties = d
        return address_usage_accumulate
