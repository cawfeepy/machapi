...
T = TypeVar("T", bound="PatchedCustomerRepresentative")


@_attrs_define
class PatchedCustomerRepresentative:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_customer_representative = cls(
            id=id,
            name=name,
            email=email,
        ...
        patched_customer_representative.additional_properties = d
        return patched_customer_representative
